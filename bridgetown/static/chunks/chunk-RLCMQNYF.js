import{a as c,b as u,c as $,d as M,e as S}from"/light-pen/bridgetown/static/chunks/chunk-HIQHELC6.js";import{a as g,b as n,k as h,l as f,m as w,n as b,o as v,p as y,q as x,s as z,t as C}from"/light-pen/bridgetown/static/chunks/chunk-RVUFNO3V.js";import{d as s}from"/light-pen/bridgetown/static/chunks/chunk-25GN2ENT.js";var k=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;function O(l,e=" "){let t=[];for(let[r,i]of Object.entries(l))i&&t.push(r);return t.join(e)}function m(l,e=0){let t=null;return(...r)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{l.apply(null,r)},e)}}var T="Show source code",o=class extends f{constructor(){super(),this.sandboxSettings=k,this.summary=T,this.language="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=m(()=>this.handleMutation("preview-code"),20),this.codeDebounce=m(()=>this.handleMutation("code"),20),this.wrap="soft"}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let r=t.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let i="type"in e&&e.type==="slotchange",a=t.assignedElements({flatten:!0}),p=y(this.unescapeTags(x(...a)).trim());if(r==="preview-code"){i&&this.resetIframeCodeMutationObserver(),this.previewCode=p;return}if(r==="code"){i&&this.resetCodeMutationObserver(),this.code=p;return}}updateIframeContent(){let e=this.previewCode||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let r=`
    ...
    `;return this.shadowRoot&&this.addShadowRootToPreview(this.shadowRoot),t}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let i=(e.currentTarget?.offsetWidth||0)/2;$(this,{onMove:(a,p)=>{let D=a+i;this.resizePosition=u(0,this.pixelsToPercentage(D),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let a=this.shadowRoot?.querySelector("iframe");a&&(a.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let r=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${r}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,r=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=r),e.key==="ArrowRight"&&(t+=r),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=u(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(o,"baseName","light-preview-base"),s(o,"dependencies",{"light-disclosure":S}),s(o,"styles",[w,b,R]),s(o,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},language:{},code:{attribute:!1},previewCode:{attribute:!1}});var d=class extends o{highlight(e=this.code){return C(e,z.languages[this.language],this.language)}};s(d,"baseName","light-preview"),s(d,"styles",o.styles.concat([v]));export{d as a};
//# sourceMappingURL=/light-pen/bridgetown/static/chunks/chunk-RLCMQNYF.js.map
