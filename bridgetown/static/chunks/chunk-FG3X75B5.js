...
function dedent(templateStrings, ...values) {
  ...
  for (let i3 = 0; i3 < strings.length; i3++) {
    ...
    if (match = strings[i3].match(new RegExp(`
...
(	| ){${size}}`, "g");
    for (let i3 = 0; i3 < strings.length; i3++) {
      strings[i3] = strings[i3].replaceAll(pattern, "\n");
    }
  }
  return interpolate(strings, values);
}
...
prism-esm/prism-core.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/bridgetown/static/chunks/chunk-FG3X75B5.js.map
