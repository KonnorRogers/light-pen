import{a as A,b as n,c as u,d as w,e as z,f,g as T,h as d,i as C,j as _,k as R,l as b,m as v,n as g,o as k,p as j,q as S,r as D,s as x,t as P,u as M,v as O,w as E}from"/light-pen/bridgetown/static/chunks/chunk-PSWCXD6S.js";import{d as l}from"/light-pen/bridgetown/static/chunks/chunk-25GN2ENT.js";var H=A`
[part~="sandbox-iframe"] {
  width: 100%;
  height: 100%;
...
`)));this[`${r}Code`]=m;let y=this[`${r}TextArea`];y&&m&&(y.value=m)}renderConsole(){return n`<div part="sandbox-console-log"></div>`}render(){return n`
      ...
      <div part="base" ?resizing=${this.resizing}>
		...
		</div>`}handleDrag(e){e.cancelable&&e.preventDefault(),this.iframeElem&&(this.iframeElem.style.pointerEvents="none"),this.resizing=!0,M(this,{onMove:(t,s)=>{this.resizing=!0;let r=t;this.resizePosition=x(this.pixelsToPercentage(r),0,100),this.updateResizePosition()},onStop:()=>{this.iframeElem&&(this.iframeElem.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}pixelsToPercentage(e){return e/this.cachedWidth*100}renderDetails(e){let t=e.toUpperCase(),s=this[`${e}Code`];s=s?k(this.highlightCode({code:s,language:e})):"";let r=this.openLanguages.split(",").includes(e);return n`
      <details ?open=${r} part="details details-${e}">
		...
		`}syncScroll(e){let t=e.target;if(t==null)return;let s=t.dataset.codeLang,r=this.shadowRoot?.querySelector(`#pre-${s}`);r!=null&&(r.scrollTop=t.scrollTop,r.scrollLeft=t.scrollLeft)}};l(a,"baseName","light-pen"),l(a,"styles",[S,D,T,H]),l(a,"languageMap",{html:"xml",css:"css",js:"javascript"}),l(a,"properties",{openLanguages:{reflect:!0,attribute:"open-languages"},resizePosition:{attribute:"resize-position",reflect:!0,type:Number},console:{reflect:!0},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},languages:{attribute:!1,type:Array},cssCode:{attribute:!1},htmlCode:{attribute:!1},jsCode:{attribute:!1},htmlResizeObserver:{attribute:!1},jsResizeObserver:{attribute:!1},cssResizeObserver:{attribute:!1},resizing:{attribute:!1},iframeSrcDoc:{attribute:!1}});export{a};
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/bridgetown/static/chunks/chunk-F3CDJQ6C.js.map
