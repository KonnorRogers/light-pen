// node_modules/.pnpm/@shoelace-style+shoelace@2.15.1_@types+react@18.3.3/node_modules/@shoelace-style/shoelace/dist/chunks/chunk.IFDWM6P4.js
...
var b = class extends HTMLElement {
  ...
  requestUpdate(t3, s4, i4) {
    if (void 0 !== t3) {
      if (i4 ?? (i4 = this.constructor.getPropertyOptions(t3)), !(i4.hasChanged ?? f)(this[t3], s4)) return;
      this.P(t3, s4, i4);
    }
...
var R = class {
  ...
  _$AI(t3, i4 = this, s4, e4) {
    ...
    if (void 0 === h3) t3 = N(this, t3, i4, 0), o4 = !c3(t3) || t3 !== this._$AH && t3 !== w, o4 && (this._$AH = t3);
      ...
      const e5 = t3;
      let n4, r5;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++) r5 = N(this, e5[s4 + n4], i4, n4), r5 === w && (r5 = this._$AH[n4]), o4 || (o4 = !c3(r5) || r5 !== this._$AH[n4]), r5 === T ? t3 = T : t3 !== T && (t3 += (r5 ?? "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o4 && !e4 && this.j(t3);
  }
  j(t3) {
...
Z?.(V, M), (t2.litHtmlVersions ?? (t2.litHtmlVersions = [])).push("3.1.3");
var j = (t3, i4, s4) => {
...
lit-html/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/bridgetown/static/chunks/chunk-FJJKEZSU.js.map
