...
import { computeLineInformation, DiffMethod } from '../exports/components/light-diff-viewer/compute-line-info.js';
...
Also this info`;
    ...
    assert.deepEqual(computeLineInformation(oldCode, newCode, false, DiffMethod.WORDS), {
        lineInformation: [
          {
            right: {
              lineNumber: 1,
...
Also this info`;
    ...
    assert.deepEqual(computeLineInformation(oldCode, newCode, true, DiffMethod.WORDS, 5), {
        lineInformation: [
          {
            right: {
              lineNumber: 6,
