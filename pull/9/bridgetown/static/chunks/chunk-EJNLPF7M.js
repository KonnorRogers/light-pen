import{a as b,b as k,c as L,d as D}from"/light-pen/pull/9/bridgetown/static/chunks/chunk-XBT3K6UG.js";import{a as p,b as l,g as w,h as v,i as y,k as x,l as z,m,q as g,r as C,s as f,t as R,u as $,v as M,w as S,x as T,y as c,z as O}from"/light-pen/pull/9/bridgetown/static/chunks/chunk-SCGM5M5Y.js";import{d as a}from"/light-pen/pull/9/bridgetown/static/chunks/chunk-YJ24LJIO.js";var _=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;var H="Show source code",r=class extends R{constructor(){super(),this.sandboxSettings=_,this.summary=H,this.language="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=f(()=>this.handleMutation("preview-code"),20),this.codeDebounce=f(()=>this.handleMutation("code"),20),this.wrap="soft",this.unescapeBehavior="last"}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let i=t.getAttribute("name");if(["preview-code","code"].includes(i||"")===!1)return;let s="type"in e&&e.type==="slotchange",n=t.assignedElements({flatten:!0}),h=M($(...n).trim());if(i==="preview-code"){s&&this.resetIframeCodeMutationObserver(),this.previewCode=h,this.requestUpdate("previewCode");return}if(i==="code"){s&&this.resetCodeMutationObserver(),this.code=h,this.requestUpdate("code");return}}updateIframeContent(){let e=this.previewCode||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
      ...
      <div part=${C({base:!0})}>
        ...
        <light-disclosure
          id="details"
          ?open=${this.open}
          @light-toggle=${i=>this.open=i.currentTarget.open}
          part="source-details"
		...
		<pre
                ...
                ><code
                    part="code code-${e}"
                    class="language-${e}"
                  >${g(this.highlight(this.transformTags(this.code)))}</code></pre>`,()=>l`${g(this.code)}`)}
          </div>
        </light-disclosure>
        ...
        <div part="actions">
          <button class="light-button" part="source-code-toggle" aria-expanded=${this.open} aria-controls="details" @click=${()=>this.open=!this.open} type="button">
            <slot name="summary">${this.summary||H}</slot>
    ...
    `;return this.shadowRoot&&this.addShadowRootToPreview(this.shadowRoot),t}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let s=(e.currentTarget?.offsetWidth||0)/2;k(this,{onMove:(n,h)=>{let u=n+s;this.resizePosition=b(0,this.pixelsToPercentage(u),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let n=this.shadowRoot?.querySelector("iframe");n&&(n.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let i=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${i}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,i=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=i),e.key==="ArrowRight"&&(t+=i),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=b(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};a(r,"baseName","light-preview-base"),a(r,"dependencies",{"light-disclosure":D}),a(r,"styles",[w,v,S,P]),a(r,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},language:{},unescapeBehavior:{reflect:!0},code:{attribute:!1},previewCode:{attribute:!1}});function A(o,e,t,i){return o.substring(0,e)+i+o.substring(t)}function E(o,e){let t=[...o.matchAll(e)],i=t[t.length-1];if(!i||i.index==null)return o;let{index:s}=i,n=s,h=s+i[0].length,u="</"+i[1]+">";return A(o,n,h,u)}var d=class extends r{constructor(){super(),this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1}highlight(e=this.code){let t=[];return this.disableLineNumbers||(t.push(T()),t.push(O({insertedLinesRange:new c().parse(this.insertedLines),deletedLinesRange:new c().parse(this.deletedLines),highlightLinesRange:new c().parse(this.highlightLines)}))),e=z(e,x.languages[this.language],this.language,{afterTokenize:t}),e}};a(d,"baseName","light-preview"),a(d,"styles",r.styles.concat([y,p`
...
//# sourceMappingURL=/light-pen/pull/9/bridgetown/static/chunks/chunk-EJNLPF7M.js.map
