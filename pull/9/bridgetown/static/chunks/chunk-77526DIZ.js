...
`;var Xt=/\r\n|\r|\n/;function Ot(t={}){let e=t.disableLineNumbers??!1,n=t.lineNumberStart??1;return function(i){let o=[];Bt(i.tokens).forEach((s,c)=>{s.length<=0&&s.push(" "),t.disableLineNumbers!==!0&&o.push(new E("light-gutter-cell",(c+n).toString())),o.push(new E("light-line",s))}),i.tokens=o}}function Qt(t){return Array.isArray(t)?t:[t]}function Pt(t){return t.length===0?"":t.length===1&&typeof t[0]=="string"?t[0]:t}function Bt(t){let e=[],n=[e];for(let r=0;r<t.length;r++){let i=t[r];if(typeof i=="string"){let o=i.split(Xt);for(let s=0;s<o.length;s++){s>0&&n.push(e=[]);let c=o[s];c&&e.push(c)}}else{let o=Bt(Qt(i.content));if(o.length>1)for(let s=0;s<o.length;s++){s>0&&n.push(e=[]);let c=o[s];if(c.length){let a=new E(i.type,Pt(c),i.alias);a.length=c.reduce((u,l)=>u+l.length,0),e.push(a)}}else e.push(i)}}return n}var P=class{constructor(){let e=()=>{this.errors=[],this.ranges=[],this.numbers=new Set};this.reset=e,this.reset()}includes(e){if(this.numbers.has(e))return!0;if(this.ranges.length==0)return!1;for(let n of this.ranges){let[r,i]=n;if(e>=r&&e<=i)return!0}return!1}parse(e){return this.reset(),e.includes("{")?e.includes("}")?(e=e.split(/{/)[1],e?(e=e.split(/}/)[0],e.split(/,\s*/).forEach(n=>{let[r,i]=n.split(/-/),o=Number(r),s=Number(i);if(!(o==null||isNaN(o))){if(s==null||isNaN(s)){this.numbers.add(o);return}this.ranges.push([o,s])}}),this):(this.errors.push(new Error("Invalid string provided for range.")),this)):(this.errors.push(new Error("Unable to parse range. No `}` found.")),this):(this.errors.push(new Error("Unable to parse range. No `{` found.")),this)}};function Ht(t){let{highlightLinesRange:e,insertedLinesRange:n,deletedLinesRange:r}=t;return function(i){let o=1;for(let s of i.tokens)typeof s!="string"&&(e.includes(o)&&(s.type+=" line-highlight"),n.includes(o)&&(s.type+=" inserted"),r.includes(o)&&(s.type+=" deleted"),s.type.includes("light-line")&&o++)}}function Dt(){return function(t){let e=["inserted","line-highlight","deleted"];t.type.includes("light-line")&&(t.attributes.part="line",e.forEach(n=>{t.type.includes(n)&&(n==="line-highlight"&&(n="highlight"),t.attributes.part+=" line-"+n)})),t.type.includes("light-gutter-cell")&&(t.attributes.part="gutter-cell",e.forEach(n=>{t.type.includes("gutter-cell-"+n)&&(n==="line-highlight"&&(n="highlight"),t.attributes.part+=" gutter-cell-"+n)}))}}var ee=class extends ue{constructor(){super(),this.language="html",this.disableHighlight=!1,this.code="",this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.codeDebounce=Ct(()=>this.handleMutation("code"),20),this.wrap="soft",this.preserveWhitespace=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.__resizeObserver=new ResizeObserver(()=>this.__setGutterWidth())}connectedCallback(){super.connectedCallback(),this.__resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.__resizeObserver.unobserve(this)}handleMutation(e){if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let n=e.target;if(n==null)return;let r=n.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let i=n.assignedElements({flatten:!0}),o=this.unescapeTags(Tt(...i));if(this.preserveWhitespace||(o=jt(o.trim())),r==="code"){this.code=o;return}}unescapeTags(e){return e.replaceAll(/&lt;\/([\w\d\.-_]+)>/g,"</$1>")}highlight(e=this.code){let n=[];return n.push(Ot({lineNumberStart:this.lineNumberStart,disableLineNumbers:this.disableLineNumbers})),n.push(Ht({insertedLinesRange:new P().parse(this.insertedLines),deletedLinesRange:new P().parse(this.deletedLines),highlightLinesRange:new P().parse(this.highlightLines)})),_.hooks.add("wrap",Dt()),e=St(e,_.languages[this.language],this.language,{afterTokenize:n}),e}__setGutterWidth(){let e=this.shadowRoot?.querySelector("[part~='gutter-cell']")?.offsetWidth;e&&this.style.setProperty("--gutter-cell-width",`${e}px`)}render(){let e=this.language,n=X`
    ...
    `;return setTimeout(async()=>{await this.updateComplete,setTimeout(()=>this.__setGutterWidth())}),n}};C(ee,"baseName","light-code"),C(ee,"styles",[ft,Mt,mt,j`
      [part~="base"] {
        height: 100%;
        position: relative;
      }
...
lit-html/directives/unsafe-html.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/9/bridgetown/static/chunks/chunk-77526DIZ.js.map
