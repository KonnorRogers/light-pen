import{a as l,b as s,g as m,t as u}from"/light-pen/pull/9/bridgetown/static/chunks/chunk-4DEAWDKQ.js";import{d as o}from"/light-pen/pull/9/bridgetown/static/chunks/chunk-YJ24LJIO.js";function w(n,t,e){return t<n?n:t>e?e:t}function b(n,t){function e(a){let d=n.getBoundingClientRect(),p=n.ownerDocument.defaultView,c=d.left+(p?.pageXOffset||0),h=d.top+(p?.pageYOffset||0),f=a.pageX-c,g=a.pageY-h;t?.onMove&&t.onMove(f,g)}function r(){document.removeEventListener("pointermove",e),document.removeEventListener("pointerup",r),t?.onStop&&t.onStop()}document.addEventListener("pointermove",e,{passive:!0}),document.addEventListener("pointerup",r),t?.initialEvent instanceof PointerEvent&&e(t.initialEvent)}var z=s`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grip-vertical" viewBox="0 0 16 16" part="svg"><path d="M7 2a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM7 5a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM7 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-3 3a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-3 3a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"></path></svg>`;function v(){return window.matchMedia("(prefers-reduced-motion: reduce)")===!0||window.matchMedia("(prefers-reduced-motion: reduce)").matches===!0}var i=class extends u{constructor(){super(),this.summary="",this.open=!1,this._openOnToggle=!0}willUpdate(t){let e=this.details;e&&t.has("open")&&(this.open?(e.open=this.open,this._openOnToggle=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.setAttribute("expanded",""),this._openOnToggle=!0,this.dispatchEvent(new Event("light-toggle"))})})):(e.hasAttribute("expanded")?e.removeAttribute("expanded"):e.open=this.open,v()&&(e.open=this.open),this.dispatchEvent(new Event("light-toggle"))))}click(){this.open=!this.open}focus(t){this.shadowRoot?.querySelector("summary")?.focus(t)}render(){return s`
      <details
        part="details"
...
//# sourceMappingURL=/light-pen/pull/9/bridgetown/static/chunks/chunk-JS66NZZD.js.map
