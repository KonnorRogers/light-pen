import{a as R,c as $}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-WPX2IHC5.js";import{a as b,e as v,f as u,g as w,h as x,i as y,j as L,k as _,l as T,m as N,n as S,o as z,p as E,q as H}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-ETT43YUL.js";import{a as d,b as g}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-LFPVEBVM.js";import{d as m}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-VT6VFEU4.js";var M=d`
  /**
...
`;function f(){let r=new L;return w(r),_(r),x(r),T(r),y(r),N(r),S(r),z(r),E(r),H(r),r}var k=class{static get instance(){return this.__singleton__||(this.__singleton__=f()),this.__singleton__}};function A(r,e,n,t,s={}){let o=D(r,e,n,t,s);return u.stringify(t.util.encode(o.tokens),o.language,t)}function D(r,e,n,t,s={}){t||(t=k.instance),e||(e=t.languages.markup);var o={code:r,grammar:e,language:n,tokens:[]};if(t.hooks.run("before-tokenize",o),s.beforeTokenize?.forEach(i=>{i(o)}),!o.grammar)throw new Error('The language "'+o.language+'" has no grammar.');return o.tokens=t.tokenize(o.code,o.grammar),t.hooks.run("after-tokenize",o),s.afterTokenize?.forEach(i=>{i(o)}),o}function P(r,e=0){let n=null;return(...t)=>{n&&window.clearTimeout(n),n=window.setTimeout(()=>{r.apply(null,t)},e)}}function B(...r){let e=[],n=document.createElement("div");for(let t of r){if(t instanceof HTMLTemplateElement){let s=t.content.cloneNode(!0);n.append(s),e.push(n.innerHTML),n.innerHTML="";continue}if(t instanceof HTMLScriptElement){e.push(t.textContent);continue}if(t instanceof HTMLTextAreaElement){e.push(t.value);continue}e.push(t.innerHTML)}return e.join(`
`)}var I=new RegExp("(	| {2})");function C(r,...e){let n=[],t=typeof r=="string"?[r]:r.slice();function s(i,a){let l=[];l.push(i[0]);for(let h=0;h<a.length;h++)l.push(a[h]+i[h+1]);return l.join(`
`).trim()}let o=!0;for(let i=0;i<t.length;i++){let a;if(t[i].match(/\n[^\f\r\n\t ]/)){o=!1;break}(a=t[i].match(new RegExp(`
${I.source}+`,"g")))&&n.push(...a)}if(!o)return s(t,e);if(n.length){let i=Math.min(...n.map(l=>l.length-1)),a=new RegExp(`
(	| ){${i}}`,"g");for(let l=0;l<t.length;l++)t[l]=t[l].replaceAll(a,`
`)}return s(t,e)}var U=/\r\n|\r|\n/;function O(r={}){let e=r.disableLineNumbers??!1,n=r.lineNumberStart??1,t=r.callback;return typeof t!="function"&&(t=(s,o,i)=>{s.length<=0||(r.disableLineNumbers||i.push(new u("light-gutter-cell",(o+n).toString())),i.push(new u("light-line",s)))}),function(o){let i=[];q(o.tokens).forEach((a,l)=>{t(a,l,i)}),o.tokens=i}}function J(r){return Array.isArray(r)?r:[r]}function X(r){return r.length===0?"":r.length===1&&typeof r[0]=="string"?r[0]:r}function q(r){let e=[],n=[e];for(let t=0;t<r.length;t++){let s=r[t];if(typeof s=="string"){let o=s.split(U);for(let i=0;i<o.length;i++){i>0&&n.push(e=[]);let a=o[i];a&&e.push(a)}}else{let o=q(J(s.content));if(o.length>1)for(let i=0;i<o.length;i++){i>0&&n.push(e=[]);let a=o[i];if(a.length){let l=new u(s.type,X(a),s.alias);l.length=a.reduce((h,W)=>h+W.length,0),e.push(l)}}else e.push(s)}}return n}var c=class{constructor(){let e=()=>{this.errors=[],this.ranges=[],this.numbers=new Set};this.reset=e,this.reset()}includes(e){if(this.numbers.has(e))return!0;if(this.ranges.length==0)return!1;for(let n of this.ranges){let[t,s]=n;if(e>=t&&e<=s)return!0}return!1}parse(e){return this.reset(),Array.isArray(e)?(e.forEach(n=>this.numbers.add(n)),this):e instanceof Set?(this.numbers=e,this):e.includes("{")?e.includes("}")?(e=e.split(/{/)[1],e?(e=e.split(/}/)[0],e.split(/,\s*/).forEach(n=>{let[t,s]=n.split(/-/),o=Number(t),i=Number(s);if(!(o==null||isNaN(o))){if(i==null||isNaN(i)){this.numbers.add(o);return}this.ranges.push([o,i])}}),this):(this.errors.push(new Error("Invalid string provided for range.")),this)):(this.errors.push(new Error("Unable to parse range. No `}` found.")),this):(this.errors.push(new Error("Unable to parse range. No `{` found.")),this)}};function F(r){let{highlightLinesRange:e,insertedLinesRange:n,deletedLinesRange:t}=r;return function(s){let o=1;for(let i of s.tokens)typeof i!="string"&&(e.includes(o)&&(i.type+=" line-highlight"),n.includes(o)&&(i.type+=" inserted"),t.includes(o)&&(i.type+=" deleted"),i.type.includes("light-line")&&o++)}}function G(){let r=["inserted","line-highlight","deleted"];function e(n,t,s){n.type.includes(t)&&(n.attributes.part=s,r.forEach(o=>{n.type.includes(o)&&(o==="line-highlight"&&(o="highlight"),n.attributes.part+=` ${s}-${o}`)}))}return function(n){e(n,"light-line","line"),e(n,"light-gutter-cell","gutter-cell"),e(n,"light-marker","marker")}}var p=class extends ${constructor(){super(),this.language="html",this.disableHighlight=!1,this.code="",this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.codeDebounce=P(()=>this.handleMutation("code"),20),this.wrap="hard",this.preserveWhitespace=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.highlighter=f(),this.__resizeObserver=new ResizeObserver(()=>this.__setGutterMeasurements()),this.newLineRegex=/\r\n|\r|\n/,this.__highlightedCode__=""}connectedCallback(){super.connectedCallback(),this.__resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.__resizeObserver.unobserve(this)}willUpdate(e){(e.has("highlighter")||e.has("language")||e.has("code"))&&(this.__highlightedCode__=this.highlight(this.code)),super.willUpdate(e)}updated(e){if((e.has("insertedLines")||e.has("deletedLines")||e.has("highlightLines"))&&!e.has("code")){let n=this.shadowRoot?.querySelectorAll(".light-gutter-cell, .light-line");if(n?.length){let t=new c().parse(this.highlightLines),s=new c().parse(this.insertedLines),o=new c().parse(this.deletedLines);n.forEach((i,a)=>{let h=(a%2===0?a:a-1)/2+1;i.classList.toggle("line-highlight",t.includes(h)),i.part.toggle("line-highlight",t.includes(h)),i.classList.toggle("inserted",s.includes(h)),i.part.toggle("inserted",s.includes(h)),i.classList.toggle("deleted",o.includes(h)),i.part.toggle("deleted",o.includes(h))})}}super.updated(e)}handleMutation(e){if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let n=e.target;if(n==null)return;let t=n.getAttribute("name");if(["preview-code","code"].includes(t||"")===!1)return;let s=n.assignedElements({flatten:!0}),o=this.unescapeTags(B(...s));if(this.preserveWhitespace||(o=C(o.trim())),t==="code"){this.code=o;return}}unescapeTags(e){return e.replaceAll(/&lt;\/([\w\d\.-_]+)>/g,"</$1>")}highlight(e=this.code){e=e.split(this.newLineRegex).map(t=>t===""?" ":t).join(`
`),this.highlighter||(this.highlighter=f());let n=[O({lineNumberStart:this.lineNumberStart,disableLineNumbers:this.disableLineNumbers}),F({insertedLinesRange:new c().parse(this.insertedLines),deletedLinesRange:new c().parse(this.deletedLines),highlightLinesRange:new c().parse(this.highlightLines)})];return this.highlighter.hooks.add("wrap",G()),e=A(e,this.highlighter.languages[this.language],this.language,this.highlighter,{afterTokenize:n}),e}__setGutterMeasurements(){let e=this.shadowRoot?.querySelector("[part~='gutter-cell']")?.offsetWidth;e&&this.style.setProperty("--gutter-cell-width",`${e}px`);let n=this.shadowRoot?.querySelector("[part~='code']");if(n){let{offsetHeight:t,clientHeight:s}=n,o=t-s;this.style.setProperty("--scrollbar-height",`${o}px`)}}render(){let e=this.language,n=g`
      <div part="base">
        ${b(!this.disableHighlight,()=>g` <pre
              id="pre-${e}"
              data-code-lang=${e}
              aria-hidden="true"
              part="pre pre-${e}"
            ...
            ><code
              ...
              ></code></pre>`,()=>g`${v(this.code)}`)}
        <!-- This gutter is for showing when line numbers may not correspond to existing lines. -->
        ${b(this.disableLineNumbers,()=>g``,()=>g`<div part="gutter"></div>`)}
      </div>

      <div hidden>
        <slot name="code" @slotchange=${this.handleTemplate}></slot>
      </div>
    `;return setTimeout(async()=>{await this.updateComplete,setTimeout(()=>this.__setGutterMeasurements())}),n}};m(p,"baseName","light-code"),m(p,"styles",[R,j,M,d`
      :host {
        display: grid;
      }
      [part~="base"] {
    ...
    `]),m(p,"properties",{disableHighlight:{type:Boolean,attribute:"disable-highlight"},preserveWhitespace:{type:Boolean,attribute:"preserve-whitespace"},highlightLines:{attribute:"highlight-lines"},insertedLines:{attribute:"inserted-lines"},deletedLines:{attribute:"deleted-lines"},disableLineNumbers:{type:Boolean,reflect:!0,attribute:"disable-line-numbers"},lineNumberStart:{type:Number,attribute:"line-number-start"},wrap:{reflect:!0,attribute:"wrap"},language:{},code:{},highlighter:{attribute:!1,state:!0},__highlightedCode__:{attribute:!1,state:!0}});export{M as a,f as b,P as c,B as d,C as e,p as f};
//# sourceMappingURL=/light-pen/pull/38/bridgetown/static/chunks/chunk-RHOYDH2N.js.map
