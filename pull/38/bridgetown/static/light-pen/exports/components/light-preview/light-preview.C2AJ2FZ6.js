import{a as p,b as M,c as R}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-AGKR6CQY.js";import{a as g}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-6OOKXF3Q.js";import{a as $}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-7KZIYAMT.js";import{b as w,c,d as x,e as z,f as S}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-RHOYDH2N.js";import{a as b,b as v,c as y}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-WPX2IHC5.js";import{a as f}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-ETT43YUL.js";import{a as m,b as h}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-LFPVEBVM.js";import{d}from"/light-pen/pull/38/bridgetown/static/chunks/chunk-VT6VFEU4.js";var H=m`
  :host {
...
`;function T(a,e=" "){let t=[];for(let[i,s]of Object.entries(a))s&&t.push(i);return t.join(e)}function k(a,e,t,i){return a.substring(0,e)+i+a.substring(t)}function L(a,e){let t=[...a.matchAll(e)],i=t[t.length-1];if(!i||i.index==null)return a;let{index:s}=i,r=s,o=s+i[0].length,n="</"+i[1]+">";return k(a,r,o,n)}var O="Show source code",l=class extends y{constructor(){super(),this.src="",this.sandboxSettings="allow-downloads allow-forms allow-modals allow-pointer-lock allow-popups allow-presentation allow-scripts",this.summary=O,this.previewMode="iframe",this.resizing=!1,this.previewHtml="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewHtmlDebounce=c(()=>this.handleMutation("preview-html"),20),this.codeDebounce=c(()=>this.handleMutation("code"),20),this.scriptScope="document",this.language="html",this.preserveWhitespace=!1,this.disableHighlight=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.code="",this.highlighter=w(),this.wrap="soft",this.unescapeBehavior="last"}resetIframeCodeMutationObserver(){this.previewHtmlMutationObserver&&this.previewHtmlMutationObserver.disconnect(),this.previewHtmlMutationObserver=new MutationObserver((...t)=>this.previewHtmlDebounce());let e=this.findSlot("preview-html")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewHtmlMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-html"){this.handleTemplate({target:this.findSlot("preview-html")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let i=t.getAttribute("name");if(["preview-html","code"].includes(i||"")===!1)return;let s="type"in e&&e.type==="slotchange",r=t.assignedElements({flatten:!0}),o=z(x(...r).trim());if(i==="preview-html"){s&&this.resetIframeCodeMutationObserver(),this.previewHtml=o,this.requestUpdate("previewHtml");return}if(i==="code"){s&&this.resetCodeMutationObserver(),this.code=o,this.requestUpdate("code");return}}updateIframeContent(){let e=this.previewHtml||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let s=(e.currentTarget?.offsetWidth||0)/2;M(this,{onMove:(r,o)=>{let n=r+s;this.resizePosition=p(0,this.pixelsToPercentage(n),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let r=this.shadowRoot?.querySelector("iframe");r&&(r.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let i=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${i}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,i=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=i),e.key==="ArrowRight"&&(t+=i),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=p(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};d(l,"baseName","light-preview"),d(l,"dependencies",{"light-disclosure":$,"light-code":S}),d(l,"styles",[b,v,H]),d(l,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},src:{},previewMode:{reflect:!0,attribute:"preview-mode"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},scriptScope:{attribute:"script-scope"},previewHtml:{attribute:"preview-html"},unescapeBehavior:{attribute:"unescape-behavior"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},preserveWhitespace:{type:Boolean,attribute:"preserve-whitespace"},highlightLines:{attribute:"highlight-lines"},insertedLines:{attribute:"inserted-lines"},deletedLines:{attribute:"deleted-lines"},disableLineNumbers:{type:Boolean,reflect:!0,attribute:"disable-line-numbers"},lineNumberStart:{type:Number,attribute:"line-number-start"},wrap:{reflect:!0,attribute:"wrap"},language:{},code:{},highlighter:{attribute:!1,state:!0}});export{l as default};
//# sourceMappingURL=/light-pen/pull/38/bridgetown/static/light-pen/exports/components/light-preview/light-preview.C2AJ2FZ6.js.map
