import{a as i,b as r,g as a,i as o}from"/light-pen/pull/24/bridgetown/static/chunks/chunk-E37TMBAE.js";import{d as s}from"/light-pen/pull/24/bridgetown/static/chunks/chunk-WUEJL3TN.js";function d(){return window.matchMedia("(prefers-reduced-motion: reduce)")===!0||window.matchMedia("(prefers-reduced-motion: reduce)").matches===!0}var n=class extends o{constructor(){super(),this.summary="",this.open=!1,this._openOnToggle=!0}willUpdate(t){let e=this.details;e&&t.has("open")&&(this.open?(e.open=this.open,this._openOnToggle=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.setAttribute("expanded",""),this._openOnToggle=!0,this.dispatchEvent(new Event("light-toggle"))})})):(e.hasAttribute("expanded")?e.removeAttribute("expanded"):e.open=this.open,d()&&(e.open=this.open),this.dispatchEvent(new Event("light-toggle"))))}click(){this.open=!this.open}focus(t){this.shadowRoot?.querySelector("summary")?.focus(t)}render(){return r`
      <details
        part="details"
...
//# sourceMappingURL=/light-pen/pull/24/bridgetown/static/chunks/chunk-HPPTRCWI.js.map
