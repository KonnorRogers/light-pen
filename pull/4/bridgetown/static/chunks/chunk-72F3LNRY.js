...
`;var u=class extends Event{constructor(e,t={}){t.bubbles==null&&(t.bubbles=!0),t.composed==null&&(t.composed=!0),super(e,t)}};var p=class extends u{constructor(e="light-resize",t={}){super(e,t),this.height=t.height,this.width=t.width}};l.registerLanguage("javascript",w);l.registerLanguage("xml",y);l.registerLanguage("css",T);var o=class extends k{constructor(){super(),this.language="xml",this.value="",this.textarea=null}handleTextAreaResize(e){let{target:t}=e[0],{left:r,right:s,top:a,bottom:E}=e[0].contentRect,G=r+s,b=a+E;t.parentElement.style.setProperty("--textarea-height",`${b}px`),this.dispatchEvent(new p("light-resize",{height:b,width:G}))}render(){let e=this.language,t=this.value?C(this.highlightCode({code:this.value,language:e})):"";return A`
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/4/bridgetown/static/chunks/chunk-72F3LNRY.js.map
