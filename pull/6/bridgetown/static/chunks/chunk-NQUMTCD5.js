import{a as u,b as m,c as S,d as O,e as k}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-ZYPN6L7N.js";import{a as f,b as n,g as d,h as b,i as w,j as v,n as c,o as y,p as x,q as z,r as C,s as $,t as M}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-NBJH25VN.js";import{d as s}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-S5ENCXQS.js";var R=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;function D(l,e=" "){let t=[];for(let[r,o]of Object.entries(l))o&&t.push(r);return t.join(e)}function g(l,e=0){let t=null;return(...r)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{l.apply(null,r)},e)}}var _="Show source code",i=class extends y{constructor(){super(),this.sandboxSettings=R,this.summary=_,this.highlightLanguage="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=g(()=>this.handleMutation("preview-code"),20),this.codeDebounce=g(()=>this.handleMutation("code"),20)}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let r=t.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let o="type"in e&&e.type==="slotchange",a=t.assignedElements({flatten:!0}),p=$(this.unescapeCharacters(M(...a)).trim());if(r==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=p;return}if(r==="code"){o&&this.resetCodeMutationObserver(),this.code=p;return}}updateIframeContent(){let e=this.previewCode||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let r=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let o=(e.currentTarget?.offsetWidth||0)/2;S(this,{onMove:(a,p)=>{let W=a+o;this.resizePosition=m(0,this.pixelsToPercentage(W),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let a=this.shadowRoot?.querySelector("iframe");a&&(a.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let r=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${r}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,r=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=r),e.key==="ArrowRight"&&(t+=r),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=m(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(i,"baseName","light-preview-base"),s(i,"dependencies",{"light-disclosure":k}),s(i,"styles",[x,z,T]),s(i,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},highlightLanguage:{reflect:!0,attribute:"highlight-language"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},code:{attribute:!1},previewCode:{attribute:!1}});d.registerLanguage("html",w);d.registerLanguage("css",v);d.registerLanguage("javascript",b);var h=class extends i{highlight(e=this.code){return d.highlight(e,{language:this.highlightLanguage}).value}};s(h,"baseName","light-preview"),s(h,"styles",i.styles.concat([C]));export{h as a};
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-NQUMTCD5.js.map
