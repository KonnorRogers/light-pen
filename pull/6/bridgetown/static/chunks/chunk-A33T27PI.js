import{a as u,b as m,c as M,d as O,e as k}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-ZWEHUL4T.js";import{a as f,b as n,g as d,h as b,i as w,j as v,n as c,o as y,p as x,q as z,r as C,s as $,t as S}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-3KBMTWBU.js";import{d as s}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-S5ENCXQS.js";var R=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;function D(l,e=" "){let t=[];for(let[i,o]of Object.entries(l))o&&t.push(i);return t.join(e)}function g(l,e=0){let t=null;return(...i)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{l.apply(null,i)},e)}}var P="Show source code",r=class extends y{constructor(){super(),this.sandboxSettings=R,this.summary=P,this.highlightLanguage="html",this.inlinePreview=!1,this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=g(()=>this.handleMutation("preview-code"),20),this.codeDebounce=g(()=>this.handleMutation("code"),20)}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let i=t.getAttribute("name");if(["preview-code","code"].includes(i||"")===!1)return;let o="type"in e&&e.type==="slotchange",a=t.assignedElements({flatten:!0}),p=$(S(...a).trim());if(i==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=p;return}if(i==="code"){o&&this.resetCodeMutationObserver(),this.code=p;return}}unescapePreviewCode(){return this.unescapeCharacters(this.previewCode||this.code)}updateIframeContent(){let e=this.unescapePreviewCode(),t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
      ...
      <div part=${D({base:!0})}>
        <div part="preview">
          ${u(this.inlinePreview,()=>n`<div part="start-panel preview-div">${c(this.code||this.previewCode)}</div>`,()=>n`
