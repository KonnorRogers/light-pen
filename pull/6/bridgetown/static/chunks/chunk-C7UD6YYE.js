...
`;var H=class extends Event{constructor(e,t={}){t.bubbles==null&&(t.bubbles=!0),t.composed==null&&(t.composed=!0),super(e,t)}};var S=class extends H{constructor(e="light-resize",t={}){super(e,t),this.height=t.height,this.width=t.width}};var ie=(i,e,t)=>{let r=new Map;for(let s=e;s<=t;s++)r.set(i[s],s);return r},re=w(class extends y{constructor(i){if(super(i),i.type!==x.CHILD)throw Error("repeat() can only be used in text expressions")}ct(i,e,t){let r;t===void 0?t=e:e!==void 0&&(r=e);let s=[],n=[],o=0;for(let a of i)s[o]=r?r(a,o):o,n[o]=t(a,o),o++;return{values:n,keys:s}}render(i,e,t){return this.ct(i,e,t).values}update(i,[e,t,r]){var s;let n=Y(i),{values:o,keys:a}=this.ct(e,t,r);if(!Array.isArray(n))return this.ut=a,o;let p=(s=this.ut)!==null&&s!==void 0?s:this.ut=[],c=[],m,R,l=0,u=n.length-1,h=0,d=o.length-1;for(;l<=u&&h<=d;)if(n[l]===null)l++;else if(n[u]===null)u--;else if(p[l]===a[h])c[h]=f(n[l],o[h]),l++,h++;else if(p[u]===a[d])c[d]=f(n[u],o[d]),u--,d--;else if(p[l]===a[d])c[d]=f(n[l],o[d]),v(i,c[d+1],n[l]),l++,d--;else if(p[u]===a[h])c[h]=f(n[u],o[h]),v(i,n[l],n[u]),u--,h++;else if(m===void 0&&(m=ie(a,h,d),R=ie(p,l,u)),m.has(p[l]))if(m.has(p[u])){let g=R.get(a[h]),z=g!==void 0?n[g]:null;if(z===null){let G=v(i,n[l]);f(G,o[h]),c[h]=G}else c[h]=f(z,o[h]),v(i,n[l],z),n[g]=null;h++}else L(n[u]),u--;else L(n[l]),l++;for(;h<=d;){let g=v(i,c[d+1]);f(g,o[h]),c[h++]=g}for(;l<=u;){let g=n[l++];g!==null&&L(g)}return this.ut=a,X(i,c),P}});$.registerLanguage("javascript",D);$.registerLanguage("html",B);$.registerLanguage("css",O);var b=class extends W{constructor(){super(),this.language="html",this.value="",this.textarea=null,this.hasInteracted=!1,this.preserveWhitespace=!1}willUpdate(e){this.value===this.getAttribute("value")&&this.preserveWhitespace!==!0&&(this.value=this.value.trim()),super.willUpdate(e)}render(){let e=this.language,t=V(this.highlightCode({code:this.value,language:e}));return this.syncScroll(),_`
      ...
      <slot hidden @slotchange=${this.handleSlotChangeEvent}></slot>
		`}handleTextAreaResize(e){let{target:t}=e[0],{left:r,right:s,top:n,bottom:o}=e[0].contentRect,a=r+s,p=n+o;this.dispatchEvent(new S("light-resize",{height:p,width:a})),this.syncScroll(),this.injectGutterCells()}updated(e){super.updated(e),this.syncScroll(),this.injectGutterCells(),setTimeout(()=>this.setCurrentLineHighlight())}syncScroll(){let e=this.shadowRoot?.querySelector("textarea");if(e==null)return;let t=this.shadowRoot?.querySelector("pre");t&&(t.scrollTop=e.scrollTop,t.scrollLeft=e.scrollLeft);let r=this.shadowRoot?.querySelector("[part~='gutter']");r&&(r.scrollTop=e.scrollTop,r.scrollLeft=e.scrollLeft)}textareaChanged(e){if(!(e instanceof HTMLTextAreaElement))return;let t=e;this.textarea=t,this.textareaResizeObserver=new ResizeObserver(r=>this.handleTextAreaResize(r)),this.textareaResizeObserver.observe(t)}handleSlotChangeEvent(e){let r=e.target.assignedElements({flatten:!0}),s=Q(this.unescapeTags(J(...r)).trim());s&&(this.value=s,setTimeout(()=>this.textarea?.setSelectionRange(0,0)),this.dispatchEvent(new Event("light-input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("light-change",{bubbles:!0,composed:!0})))}keyupHandler(e){this.setCurrentLineHighlight(),setTimeout(()=>this.setCurrentLineHighlight())}keydownHandler(e){this.setCurrentLineHighlight(),setTimeout(()=>this.setCurrentLineHighlight())}setCurrentLineHighlight(){let e=this.shadowRoot?.querySelector("code");if(!e)return;let t=this.getCurrentLineNumber();if(this.currentLineNumber===t)return;let r=this.currentLineNumber;if(this.currentLineNumber=t,t!=null&&t>=0){let s=e.children[t];s&&(e.children[r]?.classList?.remove("is-active"),this.currentEl=s,s.classList.add("is-active"))}}highlightCode(e){let{code:t,language:r}=e;t=this.injectNewLine(t),t=$.highlight(t,{language:r}).value;let s=/\n(?!$)/;return t=t.split(s).map((n,o)=>{let a=!1;return o===this.currentLineNumber&&(a=!0),`<span class="light-line ${a?"is-active":""}">${n||" "}</span>`}).join(`
...
lit-html/directives/repeat.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-C7UD6YYE.js.map
