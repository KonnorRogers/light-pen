...
`).length-1:void 0}renderGutterCells(){let e=this.shadowRoot?.querySelector("pre > code")?.children;if(!e)return"";let t=Array.from(e);return re(t,(i,s)=>{let n=i.offsetHeight;return s+n},(i,s)=>{let n=i.getBoundingClientRect().height,a=`gutter-cell ${s===this.currentLineNumber?"gutter-cell--active":""}`;return n?_`<span part=${a} style="${`height: ${n}px`}">${s}</span>`:_`<span part=${a}>${s}</span>`})}unescapeCharacters(e){return e.replaceAll("&lt;/script>","<\/script>")}injectNewLine(e){return(e===""||e[e.length-1]===`
...
lit-html/directives/repeat.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-ZDBJZ7GK.js.map
