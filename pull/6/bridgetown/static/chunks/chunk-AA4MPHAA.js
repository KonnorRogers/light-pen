import{a as p,b as u,c as $,d as M,e as S}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-IOEJBKTQ.js";import{a as g,b as n,k as h,l as f,m as b,n as w,o as v,p as y,q as x,r as z,s as C}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-2E2APSJG.js";import{d as s}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-S5ENCXQS.js";var k=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;function R(l,e=" "){let t=[];for(let[i,o]of Object.entries(l))o&&t.push(i);return t.join(e)}function m(l,e=0){let t=null;return(...i)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{l.apply(null,i)},e)}}var T="Show source code",r=class extends f{constructor(){super(),this.sandboxSettings=k,this.summary=T,this.highlightLanguage="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=m(()=>this.handleMutation("preview-code"),20),this.codeDebounce=m(()=>this.handleMutation("code"),20)}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let i=t.getAttribute("name");if(["preview-code","code"].includes(i||"")===!1)return;let o="type"in e&&e.type==="slotchange",a=t.assignedElements({flatten:!0}),c=y(this.unescapeTags(x(...a)).trim());if(i==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=c;return}if(i==="code"){o&&this.resetCodeMutationObserver(),this.code=c;return}}updateIframeContent(){let e=this.previewCode||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let o=(e.currentTarget?.offsetWidth||0)/2;$(this,{onMove:(a,c)=>{let D=a+o;this.resizePosition=u(0,this.pixelsToPercentage(D),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let a=this.shadowRoot?.querySelector("iframe");a&&(a.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let i=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${i}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,i=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=i),e.key==="ArrowRight"&&(t+=i),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=u(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(r,"baseName","light-preview-base"),s(r,"dependencies",{"light-disclosure":S}),s(r,"styles",[b,w,O]),s(r,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},highlightLanguage:{reflect:!0,attribute:"highlight-language"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},code:{attribute:!1},previewCode:{attribute:!1}});var d=class extends r{highlight(e=this.code){return C(e,z.default.languages[this.highlightLanguage],this.highlightLanguage)}};s(d,"baseName","light-preview"),s(d,"styles",r.styles.concat([v]));export{d as a};
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-AA4MPHAA.js.map
