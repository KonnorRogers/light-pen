import{a as g,b as f,c as R,d as k,e as T}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-G4T5POF4.js";import{a as v,b as n,g as c,h as y,i as x,j as z,n as u,o as C,p as $,q as M,r as S,s as O}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-ANZGNVLF.js";import{d as s}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-S5ENCXQS.js";var D=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`);if(i==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=w;return}if(i==="code"){o&&this.resetCodeMutationObserver(),this.code=w;return}}unescapePreviewCode(){return this.unescapeCharacters(this.previewCode||this.code)}updateIframeContent(){let e=this.unescapePreviewCode(),t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let o=(e.currentTarget?.offsetWidth||0)/2;R(this,{onMove:(a,p)=>{let d=a+o;this.resizePosition=f(0,this.pixelsToPercentage(d),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let a=this.shadowRoot?.querySelector("iframe");a&&(a.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let i=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${i}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,i=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=i),e.key==="ArrowRight"&&(t+=i),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=f(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(r,"baseName","light-preview-base"),s(r,"dependencies",{"light-disclosure":T}),s(r,"styles",[$,M,P]),s(r,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},highlightLanguage:{reflect:!0,attribute:"highlight-language"},inlinePreview:{type:Boolean,attribute:"inline-preview"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},code:{attribute:!1},previewCode:{attribute:!1}});c.registerLanguage("html",x);c.registerLanguage("css",z);c.registerLanguage("javascript",y);var h=class extends r{highlight(e=this.code){return c.highlight(O(this.unescapeCharacters(e)),{language:this.highlightLanguage}).value}};s(h,"baseName","light-preview"),s(h,"styles",r.styles.concat([S]));export{h as a};
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-DWBP4TEG.js.map
