import{a as j,b as _,c as M,d as N,e as P,f as I,g as $,h as D,i as V,j as B,k as x,l as w,m as y,n as q,o as O,p as W,r as F,s as Q}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-ANZGNVLF.js";import{d as C}from"/light-pen/pull/6/bridgetown/static/chunks/chunk-S5ENCXQS.js";var{I:re}=P;var J=i=>i.strings===void 0,U=()=>document.createComment(""),v=(i,e,t)=>{var r;let s=i._$AA.parentNode,n=e===void 0?i._$AB:e._$AA;if(t===void 0){let o=s.insertBefore(U(),n),a=s.insertBefore(U(),n);t=new re(o,a,i,i.options)}else{let o=t._$AB.nextSibling,a=t._$AM,p=a!==i;if(p){let h;(r=t._$AQ)===null||r===void 0||r.call(t,i),t._$AM=i,t._$AP!==void 0&&(h=i._$AU)!==a._$AU&&t._$AP(h)}if(o!==n||p){let h=t._$AA;for(;h!==o;){let m=h.nextSibling;s.insertBefore(h,n),h=m}}}return t},f=(i,e,t=i)=>(i._$AI(e,t),i),se={},K=(i,e=se)=>i._$AH=e,X=i=>i._$AH,L=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA,r=i._$AB.nextSibling;for(;t!==r;){let s=t.nextSibling;t.remove(),t=s}};var A=(i,e)=>{var t,r;let s=i._$AN;if(s===void 0)return!1;for(let n of s)(r=(t=n)._$AO)===null||r===void 0||r.call(t,e,!1),A(n,e);return!0},T=i=>{let e,t;do{if((e=i._$AM)===void 0)break;t=e._$AN,t.delete(i),i=e}while(t?.size===0)},Y=i=>{for(let e;e=i._$AM;i=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(i))break;t.add(i),ae(e)}};function ne(i){this._$AN!==void 0?(T(this),this._$AM=i,Y(this)):this._$AM=i}function oe(i,e=!1,t=0){let r=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(r))for(let n=t;n<r.length;n++)A(r[n],!1),T(r[n]);else r!=null&&(A(r,!1),T(r));else A(this,i)}var ae=i=>{var e,t,r,s;i.type==x.CHILD&&((e=(r=i)._$AP)!==null&&e!==void 0||(r._$AP=oe),(t=(s=i)._$AQ)!==null&&t!==void 0||(s._$AQ=ne))},k=class extends y{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,r){super._$AT(e,t,r),Y(this),this.isConnected=e._$AU}_$AO(e,t=!0){var r,s;e!==this.isConnected&&(this.isConnected=e,e?(r=this.reconnected)===null||r===void 0||r.call(this):(s=this.disconnected)===null||s===void 0||s.call(this)),t&&(A(this,e),T(this))}setValue(e){if(J(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};var E=new WeakMap,Z=w(class extends k{render(i){return N}update(i,[e]){var t;let r=e!==this.G;return r&&this.G!==void 0&&this.ot(void 0),(r||this.rt!==this.lt)&&(this.G=e,this.dt=(t=i.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=i.element)),N}ot(i){var e;if(typeof this.G=="function"){let t=(e=this.dt)!==null&&e!==void 0?e:globalThis,r=E.get(t);r===void 0&&(r=new WeakMap,E.set(t,r)),r.get(this.G)!==void 0&&this.G.call(this.dt,void 0),r.set(this.G,i),i!==void 0&&this.G.call(this.dt,i)}else this.G.value=i}get rt(){var i,e,t;return typeof this.G=="function"?(e=E.get((i=this.dt)!==null&&i!==void 0?i:globalThis))===null||e===void 0?void 0:e.get(this.G):(t=this.G)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});var ee=j`
  :host {
  }
...
`;var S=class extends Event{constructor(e,t={}){t.bubbles==null&&(t.bubbles=!0),t.composed==null&&(t.composed=!0),super(e,t)}};var z=class extends S{constructor(e="light-resize",t={}){super(e,t),this.height=t.height,this.width=t.width}};var te=(i,e,t)=>{let r=new Map;for(let s=e;s<=t;s++)r.set(i[s],s);return r},ie=w(class extends y{constructor(i){if(super(i),i.type!==x.CHILD)throw Error("repeat() can only be used in text expressions")}ct(i,e,t){let r;t===void 0?t=e:e!==void 0&&(r=e);let s=[],n=[],o=0;for(let a of i)s[o]=r?r(a,o):o,n[o]=t(a,o),o++;return{values:n,keys:s}}render(i,e,t){return this.ct(i,e,t).values}update(i,[e,t,r]){var s;let n=X(i),{values:o,keys:a}=this.ct(e,t,r);if(!Array.isArray(n))return this.ut=a,o;let p=(s=this.ut)!==null&&s!==void 0?s:this.ut=[],h=[],m,R,l=0,u=n.length-1,c=0,d=o.length-1;for(;l<=u&&c<=d;)if(n[l]===null)l++;else if(n[u]===null)u--;else if(p[l]===a[c])h[c]=f(n[l],o[c]),l++,c++;else if(p[u]===a[d])h[d]=f(n[u],o[d]),u--,d--;else if(p[l]===a[d])h[d]=f(n[l],o[d]),v(i,h[d+1],n[l]),l++,d--;else if(p[u]===a[c])h[c]=f(n[u],o[c]),v(i,n[l],n[u]),u--,c++;else if(m===void 0&&(m=te(a,c,d),R=te(p,l,u)),m.has(p[l]))if(m.has(p[u])){let g=R.get(a[c]),H=g!==void 0?n[g]:null;if(H===null){let G=v(i,n[l]);f(G,o[c]),h[c]=G}else h[c]=f(H,o[c]),v(i,n[l],H),n[g]=null;c++}else L(n[u]),u--;else L(n[l]),l++;for(;c<=d;){let g=v(i,h[d+1]);f(g,o[c]),h[c++]=g}for(;l<=u;){let g=n[l++];g!==null&&L(g)}return this.ut=a,K(i,h),M}});$.registerLanguage("javascript",D);$.registerLanguage("xml",V);$.registerLanguage("css",B);var b=class extends O{constructor(){super(),this.language="xml",this.value="",this.textarea=null,this.hasInteracted=!1}render(){let e=this.language,t=q(this.highlightCode({code:this.value,language:e}));return this.syncScroll(),_`
...
`)&&(e+=" "),e}};C(b,"baseName","light-editor"),C(b,"styles",[W,ee,F]),C(b,"properties",{label:{},value:{},language:{reflect:!0},hasFocused:{attribute:"has-focused",reflect:!0}});export{b as a};
...
lit-html/directives/repeat.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/6/bridgetown/static/chunks/chunk-6RGL6TTA.js.map
