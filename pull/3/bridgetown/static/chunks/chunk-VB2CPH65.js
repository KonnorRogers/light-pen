import{a as w,b as n,e as y,f as g,g as x,h as c,i as z,j as C,k as $,o as u,p as M,q as S,r as O,s as f,t as R,u as D,v as T,w as k}from"/light-pen/pull/3/bridgetown/static/chunks/chunk-7Y3T72CV.js";import{d as s}from"/light-pen/pull/3/bridgetown/static/chunks/chunk-6S5PKM65.js";var P=w`
:host {
...
`);if(r==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=v;return}if(r==="code"){o&&this.resetCodeMutationObserver(),this.code=v;return}}unescapePreviewCode(){return this.unescapeCharacters(this.previewCode||this.code)}updateIframeContent(){let e=this.unescapePreviewCode(),t=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let o=(e.currentTarget?.offsetWidth||0)/2;D(this,{onMove:(a,p)=>{let d=a+o;this.resizePosition=f(0,this.pixelsToPercentage(d),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let a=this.shadowRoot?.querySelector("iframe");a&&(a.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let r=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${r}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,r=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=r),e.key==="ArrowRight"&&(t+=r),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=f(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(i,"baseName","light-preview-base"),s(i,"styles",[S,O,P]),s(i,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},highlightLanguage:{reflect:!0,attribute:"highlight-language"},inlinePreview:{type:Boolean,attribute:"inline-preview"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},baseUrl:{reflect:!0,attribute:"base-url"},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},iframeSrcDoc:{reflect:!0,attribute:"iframe-src-doc"},code:{attribute:!1},previewCode:{attribute:!1}});c.registerLanguage("html",C);c.registerLanguage("css",$);c.registerLanguage("javascript",z);var h=class extends i{highlight(e=this.code){return c.highlight(R(this.unescapeCharacters(e)),{language:this.highlightLanguage}).value}};s(h,"baseName","light-preview"),s(h,"styles",i.styles.concat([x]));export{h as a};
//# sourceMappingURL=/light-pen/pull/3/bridgetown/static/chunks/chunk-VB2CPH65.js.map
