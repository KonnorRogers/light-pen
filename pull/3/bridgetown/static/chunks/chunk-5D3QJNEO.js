import{a as A,b as l,c as u,d as w,e as z,f,g as T,h,i as C,j as R,k as _,l as b,m as v,n as g,o as k,p as j,q as S,r as P,s as x,t as D,u as E,v as O,w as L}from"/light-pen/pull/3/bridgetown/static/chunks/chunk-7Y3T72CV.js";import{d}from"/light-pen/pull/3/bridgetown/static/chunks/chunk-6S5PKM65.js";var M=A`
[part~="sandbox-iframe"] {
  width: 100%;
  height: 100%;
...
`;var{I:K}=w;var U=i=>i.strings===void 0;var c=(i,e)=>{var t,s;let r=i._$AN;if(r===void 0)return!1;for(let o of r)(s=(t=o)._$AO)===null||s===void 0||s.call(t,e,!1),c(o,e);return!0},p=i=>{let e,t;do{if((e=i._$AM)===void 0)break;t=e._$AN,t.delete(i),i=e}while(t?.size===0)},N=i=>{for(let e;e=i._$AM;i=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(i))break;t.add(i),B(e)}};function W(i){this._$AN!==void 0?(p(this),this._$AM=i,N(this)):this._$AM=i}function I(i,e=!1,t=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(e)if(Array.isArray(s))for(let o=t;o<s.length;o++)c(s[o],!1),p(s[o]);else s!=null&&(c(s,!1),p(s));else c(this,i)}var B=i=>{var e,t,s,r;i.type==b.CHILD&&((e=(s=i)._$AP)!==null&&e!==void 0||(s._$AP=I),(t=(r=i)._$AQ)!==null&&t!==void 0||(r._$AQ=W))},m=class extends g{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,s){super._$AT(e,t,s),N(this),this.isConnected=e._$AU}_$AO(e,t=!0){var s,r;e!==this.isConnected&&(this.isConnected=e,e?(s=this.reconnected)===null||s===void 0||s.call(this):(r=this.disconnected)===null||r===void 0||r.call(this)),t&&(c(this,e),p(this))}setValue(e){if(U(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};var $=new WeakMap,H=v(class extends m{render(i){return u}update(i,[e]){var t;let s=e!==this.G;return s&&this.G!==void 0&&this.ot(void 0),(s||this.rt!==this.lt)&&(this.G=e,this.dt=(t=i.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=i.element)),u}ot(i){var e;if(typeof this.G=="function"){let t=(e=this.dt)!==null&&e!==void 0?e:globalThis,s=$.get(t);s===void 0&&(s=new WeakMap,$.set(t,s)),s.get(this.G)!==void 0&&this.G.call(this.dt,void 0),s.set(this.G,i),i!==void 0&&this.G.call(this.dt,i)}else this.G.value=i}get rt(){var i,e,t;return typeof this.G=="function"?(e=$.get((i=this.dt)!==null&&i!==void 0?i:globalThis))===null||e===void 0?void 0:e.get(this.G):(t=this.G)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});h.registerLanguage("javascript",C);h.registerLanguage("xml",R);h.registerLanguage("css",_);var a=class extends j(z){constructor(){super(),this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.htmlResizeObserver=new ResizeObserver(e=>this.handleTextAreaResize(e)),this.jsResizeObserver=new ResizeObserver(e=>this.handleTextAreaResize(e)),this.cssResizeObserver=new ResizeObserver(e=>this.handleTextAreaResize(e)),this.resizePosition=50,this.openLanguages="",this.languages=["html","css","js"],this.console="disabled",this.consoleText="",this.htmlReset="",this.cssReset="",this.jsReset="",this.cachedWidth=0,this.sandboxSettings="",this.resizing=!1,this.baseUrl="",this.iframeSrcDoc=""}connectedCallback(){super.connectedCallback(),this.updateCachedWidth(),this.updateComplete.then(()=>{this.resizeObserver.observe(this),this.htmlReset=this.htmlTextArea?.value||"",this.cssReset=this.cssTextArea?.value||"",this.jsReset=this.jsTextArea?.value||""})}handleTextAreaResize(e){let{target:t}=e[0],{top:s,bottom:r}=e[0].contentRect,o=s+r;t.parentElement.style.setProperty("--textarea-height",`${o}px`)}updateCachedWidth(){let{left:e,right:t}=this.getBoundingClientRect(),s=e+t;this.cachedWidth=s}handleResize(e){let{left:t,right:s}=e[0].contentRect,r=t+s;this.cachedWidth=r}get iframeElem(){return this.shadowRoot?.querySelector("iframe")}highlightCode(e){let{code:t,language:s}=e,r=this.constructor.languageMap[s];return t=this.unescapeCharacters(t),t=this.injectNewLine(t),h.highlight(t,{language:r}).value}unescapeCharacters(e){return e.replaceAll("&lt;/script>","<\/script>")}injectNewLine(e){return e[e.length-1]==`
`&&(e+=`
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/light-pen/pull/3/bridgetown/static/chunks/chunk-5D3QJNEO.js.map
